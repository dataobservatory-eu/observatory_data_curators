...
These are the EU’s official strategic policies for the next decade. We want to contest at least [Challenge 1](#challenge-green-deal) and  [Challenge 3](#challenge-digital-age), and if we find enough partners and volunteers, also [Challenge 2](#challenge-economy.

For Challenge 1, we are preparing the [Green Deal Data Observatory](http://greendeal.dataobservatory.eu/). For Challenge 3, we will rebrand our [Digital Music Observatory](https://music.dataobservatory.eu/) to highlight our efforts in trustworthy, ethical AI, and to find a new balance between the interests of artists and music audiences. 
