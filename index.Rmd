...
For Challenge 2, the [Economy Data Observatory](https://economy.dataobservatory.eu/) -- any better name is welcome.
For Challenge 3, our [Digital Music Observatory](https://music.dataobservatory.eu/) to highlight our efforts in trustworthy, ethical AI, and to find a new balance between the interests of artists and music audiences. 
...
```{r observatories, fig.out="85%", fig.align="center", echo=FALSE}
